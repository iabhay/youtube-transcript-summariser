...
class Config:
    ...
    PREMIUM_USER_ROLE_NAME = None
    NON_PREMIUM_USER_ROLE_NAME = None
    BAN_STATUS_FIELD_NAME = None
    BANNED_FIELD_NAME = None
    UNBANNED_FIELD_NAME = None
    UPGRADE_SUCCESS_PROMPT = None
    DOWNGRADE_SUCCESS_PROMPT = None
    REGISTRATION_SUCCESS_PROMPT = None
    SHORT_UID_CONSTRAINTS = None
    NO_DATA_EXIST_PROMPT = None
    DATE_FORMAT = None
    USER_BANNED_NOTICE_PROMPT = None
    VIDEO_NOT_SUPPORTED_PROMPT = None
    ADMIN_UPDATED_MENU = None
    ADMIN_USER_OPS_MENU = None
    ADMIN_URL_OPS_MENU = None
    ADMIN_PREMIUM_LISTING_OPS_MENU = None
    ADMIN_HISTORY_OPS_MENU = None
    ADMIN_UPDATED_MENU_LENGTH = None
    ADMIN_USER_OPS_MENU_LENGTH = None
    ADMIN_URL_OPS_MENU_LENGTH = None
    ADMIN_PREMIUM_LISTING_OPS_MENU_LENGTH = None
    ADMIN_HISTORY_OPS_MENU_LENGTH = None
    VALUE_ERROR_PROMPT = None
    LISTING_ERROR_PROMPT = None
    ...
    def load(cls):
        with open(FPATH, 'r') as f:
            ...
            cls.ROLE_FIELD = data['ROLE_FIELD']
            cls.ADMIN_ROLE_NAME = data['ADMIN_ROLE_NAME']
            cls.PREMIUM_USER_ROLE_NAME = data['PREMIUM_USER_ROLE_NAME']
            cls.NON_PREMIUM_USER_ROLE_NAME = data['NON_PREMIUM_USER_ROLE_NAME']
            cls.BAN_STATUS_FIELD_NAME = data['BAN_STATUS_FIELD_NAME']
            cls.BANNED_FIELD_NAME = data['BANNED_FIELD_NAME']
            cls.UNBANNED_FIELD_NAME = data['UNBANNED_FIELD_NAME']
            cls.UPGRADE_SUCCESS_PROMPT = data['UPGRADE_SUCCESS_PROMPT']
            cls.DOWNGRADE_SUCCESS_PROMPT = data['DOWNGRADE_SUCCESS_PROMPT']
            cls.REGISTRATION_SUCCESS_PROMPT = data['REGISTRATION_SUCCESS_PROMPT']
            cls.SHORT_UID_CONSTRAINTS = data['SHORT_UID_CONSTRAINTS']
            cls.NO_DATA_EXIST_PROMPT = data['NO_DATA_EXIST_PROMPT']
            cls.DATE_FORMAT = data['DATE_FORMAT']
            cls.USER_BANNED_NOTICE_PROMPT = data['USER_BANNED_NOTICE_PROMPT']
            cls.VIDEO_NOT_SUPPORTED_PROMPT = data['VIDEO_NOT_SUPPORTED_PROMPT']
            cls.ADMIN_UPDATED_MENU = data['ADMIN_UPDATED_MENU']
            cls.ADMIN_USER_OPS_MENU = data['ADMIN_USER_OPS_MENU']
            cls.ADMIN_URL_OPS_MENU = data['ADMIN_URL_OPS_MENU']
            cls.ADMIN_PREMIUM_LISTING_OPS_MENU = data['ADMIN_PREMIUM_LISTING_OPS_MENU']
            cls.ADMIN_HISTORY_OPS_MENU = data['ADMIN_HISTORY_OPS_MENU']
            cls.ADMIN_UPDATED_MENU_LENGTH = data['ADMIN_UPDATED_MENU_LENGTH']
            cls.ADMIN_USER_OPS_MENU_LENGTH = data['ADMIN_USER_OPS_MENU_LENGTH']
            cls.ADMIN_URL_OPS_MENU_LENGTH = data['ADMIN_URL_OPS_MENU_LENGTH']
            cls.ADMIN_PREMIUM_LISTING_OPS_MENU_LENGTH = data['ADMIN_PREMIUM_LISTING_OPS_MENU_LENGTH']
            cls.ADMIN_HISTORY_OPS_MENU_LENGTH = data['ADMIN_HISTORY_OPS_MENU_LENGTH']
            cls.VALUE_ERROR_PROMPT = data['VALUE_ERROR_PROMPT']
            cls.LISTING_ERROR_PROMPT = data['LISTING_ERROR_PROMPT']